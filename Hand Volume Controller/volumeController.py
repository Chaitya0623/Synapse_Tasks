...
webcamFeed = cv2.VideoCapture(0) # Opens a new window as webcam, the first webcam (if multiple)
...
while True:
    ...
    if (len(handLandMarks) != 0):
        ...
        volumeValue = np.interp(length, [50,250], [-65.25, 0]) # Already defined value
